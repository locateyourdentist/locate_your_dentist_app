...
final accountSettings = settingList.where((e) => ["Profile", "Clinic Profile", "Lab Profile", "Shop Profile", "Edit Profile", "Add Profile", "Change Password"].contains(e['title'])).toList();
final managementSettings = settingList.where((e) => !["Profile", "Clinic Profile", "Lab Profile", "Shop Profile", "Edit Profile", "Add Profile", "Change Password", "About Us", "Contact Us", "Logout", "Delete Account"].contains(e['title'])).toList();
final supportSettings = settingList.where((e) => ["About Us", "Contact Us", "Delete Account", "Logout"].contains(e['title'])).toList();
...
body: SafeArea(
    ...
    Container(
      ...
      child: Stack(
        ...
        children: [
          ...
          SizedBox(
            width: double.infinity, // Forces the column space to occupy full width for absolute centering
            child: Column(
              mainAxisSize: MainAxisSize.min,
              crossAxisAlignment: CrossAxisAlignment.center, // Centers internal text & image layout elements
              children: [
                ...
                Container(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage: userImg.isNotEmpty
                        ...
                        : const AssetImage("assets/images/doctor5.jpg") as ImageProvider,
                  ),
                ),
  ...
  Text(
  'App Version 1.0.0',
  style: TextStyle(color: Colors.grey.shade500, fontSize: 12, fontWeight: FontWeight.w500, letterSpacing: 0.5),
  ),
  const SizedBox(height: 4),
  Text(
...
child: Text(
title.toUpperCase(),
style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xFF64748B), letterSpacing: 1.2),
),
);
}
...
separatorBuilder: (context, index) => Divider(height: 1, color: Colors.grey.shade100, indent: 54),
itemBuilder: (context, index) {
final item = items[index];
final String title = item['title'] ?? '';
final bool isDestructive = ["Delete Account", "Logout"].contains(title);
...
decoration: BoxDecoration(
color: isDestructive
? (title == "Logout" ? Colors.orange.shade50 : Colors.red.shade50)
...
fontSize: 14,
color: isDestructive
? (title == "Logout" ? Colors.orange.shade800 : Colors.red.shade800)
...
size: 14,
color: isDestructive ? Colors.grey.shade300 : const Color(0xFF94A3B8),
),
onTap: () async {
if (title == "Logout") {
showLogoutDialog(context);
