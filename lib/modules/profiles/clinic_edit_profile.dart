              ...
              children: [
                ...
                Center(
                  ...
                  // SizedBox(height: size*0.02,),
                   ...
                   Center(child: Text("** maximum 3 images/pdf allowed",style: TextStyle(color: Colors.redAccent,fontSize: size*0.019,fontWeight: FontWeight.normal),)),
                        ...
                        child: ElevatedButton(onPressed: ()async
                        {
                          if (_formKeyEditProfile.currentState!.validate()) {
                            ...
                            await loginController.registerUser(
                              ...
                              logoImage: controller.logoImages ?? [],
...
Widget buildMediaItem(AppImage media, double size, VoidCallback onDelete) {
  return Container(
    margin: const EdgeInsets.all(8),
    width: size * 0.3,
    height: size * 0.3,
