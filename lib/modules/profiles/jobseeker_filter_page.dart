...
class _JobSeekerFilterState extends State<JobSeekerFilter> {
  ...
  final GlobalKey<ScaffoldState> _scaffoldKeyJobSeekers =
                  ...
                  showModalBottomSheet(
                    ...
                    builder: (context) {
                      return FractionallySizedBox(
                        heightFactor:
                            0.75, // 75% of screen height (not full screen)
                        child: FilterDrawer(
                          onApply: () async {
                            print(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "Total Profiles : ${jobController.jobListJobSeekers.isNotEmpty ? jobController.jobListJobSeekers.length.toString() : "0"}",
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Flexible(
                                                  child: Text(
                                                    'Posted On ${DateFormat('MMM dd, yyyy').format(DateTime.parse(Jobs.createdDate.toString()))}',
                                                    overflow:
                                                        TextOverflow.ellipsis,
                                                    style: TextStyle(
                                                      fontSize: size * 0.03,
                                                ...
                                                Align(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Center(
                                                        child: Text(
                                                          '${Jobs.totalApplicants.toString()} Applied',
                                                          style: TextStyle(
                                                            fontSize:
                                                                size * 0.03,
                                                            fontWeight:
