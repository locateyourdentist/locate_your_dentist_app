...
class _CreateJobPostState extends State<CreateJobPost> {
  ...
  void initState() {
    ...
    jobController.selectedJobId.toString().isNotEmpty
        ? jobController.selectedJobId.toString()
        : "0";
    print(
      'jobid${jobController.selectedJobId}webid${jobController.selectedWebinarId.toString()}',
    );
                        ...
                        children: [
                          ...
                          CustomDropdownField(
                            ...
                            selectedValue:
                                ([
                                  ...
                                  "Part Time",
                                  "Remote",
                                ].contains(loginController.selectedJobType))
                          ...
                          GetBuilder<JobController>(
                            builder: (jobController) {
                              ...
                              categoryItems = jobController.jobCategoryAdmin
                                  .map(
                                ...
                                child: GetBuilder<LoginController>(
                                  builder: (controller) {
                                    ...
                                    if (controller.jobFileImages.isNotEmpty) {
                                      final img =
                                          controller.jobFileImages.first;
                          ...
                          Center(
                            child: Container(
                              ...
                              child: ElevatedButton(
                                onPressed: () async {
                                  if (_formKeyCreateJob.currentState!
                                      .validate()) {
                                    print(
                                    ...
                                    if ((jobController.startHour != null &&
                                            jobController
                                                .startHour!
                                                .isNotEmpty) &&
                                        (jobController.startMinutes != null &&
                                            jobController
                                                .startMinutes!
                                                .isNotEmpty) &&
                                        (jobController.startPeriod != null &&
                                            jobController
                                                .startPeriod!
                                                .isNotEmpty)) {
                                      jobStartTime =
                                    ...
                                    if ((jobController.endHour != null &&
                                            jobController
                                                .endHour!
                                                .isNotEmpty) &&
                                        (jobController.endMinutes != null &&
                                            jobController
                                                .endMinutes!
                                                .isNotEmpty) &&
                                        (jobController.endPeriod != null &&
                                            jobController
                                                .endPeriod!
                                                .isNotEmpty)) {
                                      jobEndTime =
                                    ...
                                    if (loginController.selectedJobType ==
                                        null) {
                                      showCustomToast(
                                        context,
                                    ...
                                    if (loginController
                                      ...
                                      showCustomToast(
                                        context,
                                        "Please Choose Job category",
                                      );
                                      return;
                                    }

                                    if (loginController.selectedSalary ==
                                        null) {
                                      showCustomToast(
                                        context,
                                    ...
                                    if (loginController.selectedExperience ==
                                        null) {
                                      showCustomToast(
                                        context,
                                        "Please Choose experience",
                                      );
                                      return;
                                    }
                                    ...
                                    await jobController.postJobsAdmin(
                                      ...
                                      jobEndTime.toString(),
                                      loginController.jobImages1.isNotEmpty
                                          ? loginController.jobImages1
                                          : [],
                                      context,
                                    );
                                    await jobController.getJobListAdmin(
                                      context,
                                    );
                                  }
                                  // else{
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomTextField(
                            ...
                            icon: Icons.title,
                            controller:
                                loginController.webinarTitleJobController,
                            fillColor: AppColors.white,
                            borderColor: AppColors.grey,
                          ),
                          SizedBox(height: size * 0.03),
                                ...
                                child: GetBuilder<LoginController>(
                                  builder: (controller) {
                                    if (controller.webinarImages1.isNotEmpty) {
                                      final file =
                                          controller.webinarImages1.first;
                                      return _buildSingleImageWidget(
                                        file: file,
                                      );
                                    }
                                    if (controller
                                        ...
                                        .isNotEmpty) {
                                      final img =
                                          controller.webinarFileImages.first;
                                      print('web img url${img.url}');
                                      return _buildSingleImageWidget(
                                        url: "${img.url}",
                                      );
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                if (_formKeyCreateWebinar.currentState!
                                    .validate()) {
                                  if ((loginController.startHour != null &&
                                          loginController
                                              .startHour!
                                              .isNotEmpty) &&
                                      (loginController.startMinutes != null &&
                                          loginController
                                              .startMinutes!
                                              .isNotEmpty) &&
                                      (loginController.startPeriod != null &&
                                          loginController
                                              .startPeriod!
                                              .isNotEmpty)) {
                                    startTime =
                                  ...
                                  if ((loginController.endHour != null &&
                                          loginController
                                              .endHour!
                                              .isNotEmpty) &&
                                      (loginController.endMinutes != null &&
                                          loginController
                                              .endMinutes!
                                              .isNotEmpty) &&
                                      (loginController.endPeriod != null &&
                                          loginController
                                              .endPeriod!
                                              .isNotEmpty)) {
                                    endTime =
                                  ...
                                  if (jobController.webinar.isNotEmpty) {
                                    isSameDay = isWithinOneDay(
                                      jobController.webinar.first.createdDate
                                              .toString() ??
                                          "",
                                    );
                                  }
