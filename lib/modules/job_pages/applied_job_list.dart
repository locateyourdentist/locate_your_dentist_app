                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Flexible(child: Text("${appliedJobs.city.toString()??"N/A"},${appliedJobs.district.toString()??"N/A"}",overflow: TextOverflow.ellipsis,style: TextStyle(fontSize: size*0.03,fontWeight: FontWeight.normal,color: Colors.grey),)),
                                                      ],
                                                    ),
                                                    Row(
                                                      children: [
