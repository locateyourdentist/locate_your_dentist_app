  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        iconTheme: IconThemeData(color: AppColors.white, size: size * 0.05),
        backgroundColor: AppColors.white,
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        confirmRemoveImage(context, index, () {
                                          loginController.editImages.removeAt(
                                            index,
                                          );
                          ...
                          onPressed: () async {
                            if (_formKeyContactProfile.currentState!
                              ...
                              contactController.postContactDetail(
                                ...
                                contactController
                                    .contactClinicNameController
                                    .text,
                                contactController.doctorNameController.text,
                                contactController.contactDetailsController.text
                                    .toString(),
                                state,
                                district,
                                city,
