...
class ContactController extends GetxController {
  ...
  List<PublicContactModel> get publicContactFormLists =>
  ...
  Future<void> postContactDetail(
    ...
    try {
      final response = await api.postContactDetail(
        senderUserId,
        receiverUserId,
        email,
        mobileNumber,
  ...
  Future<void> postPublicContactDetail(
    String email,
    String mobileNumber,
    String name,
    String description,
    ...
    try {
      final response = await api.postPublicContactDetail(
        email,
        mobileNumber,
        name,
        description,
  ...
  Future<void> postFilterResults(
    ...
    try {
      _filterContactLists = [];
      final response = await api.contactFilterSearch(
        receiverUserId,
        senderUserId,
        state,
        district,
  ...
  Future<void> getSenderContactFormLists(
    String senderId,
    String fromDate,
    String toDate,
    String search,
    ...
    try {
      _senderContactLists = [];
      final response = await api.getSenderContactLists(
        senderId,
        fromDate,
        toDate,
        search,
  ...
  Future<void> getFeedbackFormLists(
    String fromDate,
    String toDate,
    String search,
    dynamic context,
    ...
    try {
      ...
      if (data["status"].toString().toLowerCase() == "success") {
        ...
        List<dynamic> jobs = data["data"];
        _publicContactFormLists = jobs
            .map((e) => PublicContactModel.fromJson(e))
            .toList();
        update();
      } else {
        showCustomToast(
          context,
          "can not get FeedbackFormLists: ${data["message"]}",
        );
      }
    } catch (e) {
  ...
  Future<void> getReceiverContactFormLists(
    ...
    try {
      ...
      final response = await api.getReceiverContactFormLists(
        receiverId,
        fromDate,
        toDate,
        search,
      ...
      if (data["status"].toString().toLowerCase() == "success") {
        ...
        showCustomToast(
          context,
          "can not get receiver list: ${data["message"]}",
        );
      }
    } catch (e) {
      print('view Jobs  list error $e');
