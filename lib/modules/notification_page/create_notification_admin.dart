...
class CreateNotificationAdmin extends StatefulWidget {
  ...
  @override
  State<CreateNotificationAdmin> createState() =>
      _CreateNotificationAdminState();
}
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                        ...
                        return DefaultTextStyle(
                          ...
                          child: CustomDropdown<String>.search(
                            ...
                            items: loginController.states
                                ...
                                .toList(),
                            initialItem:
                                loginController.states.contains(
                        ...
                        builder: (controller) {
                          return CustomDropdown<String>.search(
                            ...
                            items: loginController.districts
                                ...
                                .toList(),
                            initialItem:
                                loginController.districts.contains(
                            ...
                            onChanged: (val) {
                              ...
                              if (val != null) {
                                final district = loginController.districts
                                    .firstWhere((d) => d == val);
                                loginController.fetchTalukas(
                                  district.toString(),
                                );
                                print(
                                  'selectedDistrict${loginController.selectedDistrict}',
                                );
                    ...
                    GetBuilder<LoginController>(
                      builder: (controller) {
                        final items = loginController.talukas
                            ...
                            .toList();
                        final initialItem =
                            items.contains(loginController.selectedTaluka)
                        ...
                        return DefaultTextStyle(
                          ...
                          child: CustomDropdown<String>.search(
                            ...
                            onChanged: (val) {
                              ...
                              if (val != null) {
                                final taluka = loginController.talukas
                                    .firstWhere((t) => t == val);
                    ...
                    GetBuilder<LoginController>(
                      builder: (controller) {
                        final items = loginController.villages
                            .map((v) => v.toString())
                            .toList();
                        final initialItem =
                            items.contains(loginController.selectedVillage)
                          ...
                          child: GetBuilder<NotificationController>(
                            builder: (controller) {
                              if (controller.notificationImage.isNotEmpty) {
                                final file = notificationController
                                    .notificationImage
                                    .first;
                                return _buildSingleImageWidget(file: file);
                              }
                              if (notificationController
                                  .notificationFileImages
                                  .isNotEmpty) {
                                final img = notificationController
                                    .notificationFileImages
                                    .first;
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              if (notificationController.selectedUserType ==
                                  null) {
                                showCustomToast(
                                  context,
                              ...
                              if (notificationController.selectedTitle ==
                                  null) {
                              ...
                              if (notificationController
                                  .notificationImage
                                  .isNotEmpty) {
                                imageBytes = await notificationController
                                    .notificationImage
                                    .first
                                    .readAsBytes();
                              }
                              ...
                              notificationController.createNotification(
                                ...
                                notificationController.selectedTitle == "Others"
                                    ? notificationController
                                          .titleController
                                          .text
                                    : notificationController.selectedTitle
                                          .toString(),
                                notificationController.messageController.text,
                                loginController.selectedState.toString(),
                                loginController.selectedDistrict.toString(),
