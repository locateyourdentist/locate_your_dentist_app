...
//                   Center(
//                     child: Container(
//                       constraints:  BoxConstraints(maxWidth:isDesktop? 1100:300),
...
class AboutUsWebPage extends StatelessWidget {
  ...
  final GlobalKey<ScaffoldState> _scaffoldKeyAbout =
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  "Our vision is to build a connected digital network for the dental industry "
                                      "where clinics, laboratories, suppliers, and professionals collaborate efficiently and grow together.",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
