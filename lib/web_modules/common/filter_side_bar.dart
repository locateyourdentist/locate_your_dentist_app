                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          if (loginController.filterUserType ==
                              'Dental Consultant') ...[
                            const Divider(),
                            ...
                            Wrap(
                              ...
                              children: ["Morning", "Evening"].map((slot) {
                                final selected = loginController
                                ...
                                Expanded(
                                  child: TextField(
                                    controller: loginController
                                        .filterAvailableLocationController,
                                    decoration: const InputDecoration(
                                      isDense: true,
                                      hintText: "Add a location",
                                      border: OutlineInputBorder(),
                                    ),
                                    onSubmitted: (_) => loginController
                                        .addFilterAvailableLocation(),
                                  ),
                                ),
                                IconButton(
                                  icon: const Icon(
                                ...
                                children: loginController
                                    ...
                                    .map((loc) {
                                      return Chip(
                                        ...
                                        onDeleted: () => loginController
                                            .removeFilterAvailableLocation(loc),
                                      );
                                    })
                                    .toList(),
                              ),
                            ...
                            child: MultiSelectDialogField<String>(
                              ...
                              buttonText: Text(
                                loginController.selectedTalukas.isEmpty
                                    ? "Taluka"
                                    : loginController.selectedTalukas.length ==
                                          1
                            ...
                            child: MultiSelectDialogField<String>(
                              ...
                              buttonText: Text(
                                loginController.selectedVillages.isEmpty
                                    ? "Areas"
                                    : loginController.selectedVillages.length ==
                                          1
            ...
            child: ElevatedButton(
              ...
              onPressed: () async {
                ...
                String safeLng =
                    ...
                    : "";
                final filterDegree =
                    loginController.filterUserType == 'Dental Consultant'
                    ? loginController.filterSelectedDegree
                    : null;
                ...
                if (Api.userInfo.read('userType') == "superAdmin") {
                  await loginController.getProfileDetails(
                    ...
                    availableLocations: filterLocations,
                    availableTiming: filterTiming,
                  );
