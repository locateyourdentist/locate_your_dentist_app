                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (userType == 'superAdmin')
                                _buildFilterSection(width, isMobile),
                ...
                return CustomDropdown<String>.search(
                  ...
                  onChanged: (val) async {
                    if (val != null) {
                      ...
                      await planController.getIncomeDetailsByPlan(
                        state: val,
            ...
            child: CustomTextField(
              ...
              onTap: () async {
                ...
                if (picked != null) {
                  ...
                  await controller.getIncomeDetailsByPlan(
                    state: loginController.selectedState,
                    fromDate: fromDateController.text,
                    toDate: toDateController.text,
                    context: context,
          ...
          children: [
            ElevatedButton.icon(
              onPressed: () => exportExcelWeb(
                ...
                state: loginController.selectedState ?? "All",
                fromDate: fromDateController.text,
                toDate: toDateController.text,
              ),
  ...
  Widget _buildDetailsGrid(
    ...
    return Row(
      ...
      children: [
        ...
        Expanded(
          flex: 2,
          child: _buildChartsSection(width, isMobile, controller),
        ),
      ],
    );
  }
  ...
  Widget _buildIncomeDetails(PlanController controller) {
    ...
    return Column(
      ...
      children: [
        ...
        Center(
          child: Text("Income Details", style: AppTextStyles.subtitle(context)),
        ),
        const SizedBox(height: 20),
        _incomeTile(
          "Poster Income",
