...
class _InvoiceListPageWebState extends State<InvoiceListPageWeb> {
  ...
  final GlobalKey<ScaffoldState> _scaffoldKeyInvoice =
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: ListView.builder(
                                          itemCount:
                                              planController.invoiceList.length,
                                          itemBuilder: (context, index) {
                                            final invoice = planController
                                                .invoiceList[index];
                                            ...
                                            onDownloadPressed() async {
                                              ...
                                              final invoiceId = planController
                                                  .invoiceDetails
                                                  .first;
                                              await PdfGenerator.generateInvoicePdf(
                                                userName: name,
