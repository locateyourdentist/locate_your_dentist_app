...
class _SalePostListWebPageState extends State<SalePostListWebPage> {
  final GlobalKey<ScaffoldState> _scaffoldKeySaleList =
                      ...
                      if (isLoggedIn && !isDesktop)
                        Align(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () =>
                                _scaffoldKeySaleList.currentState?.openDrawer(),
                          ),
                        ),
                      Container(
                            ...
                            Expanded(
                              child: TextField(
                                ...
                                decoration: const InputDecoration(
                                  hintText:
                                      "Search listings by keyword or user type...",
                                  hintStyle: TextStyle(
                                    color: AppColors.black,
                                    fontWeight: FontWeight.bold,
                                  ),
