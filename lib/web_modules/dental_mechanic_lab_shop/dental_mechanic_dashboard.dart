...
class DentalMechanicWebDashboard extends StatefulWidget {
  ...
  @override
  State<DentalMechanicWebDashboard> createState() =>
      _DentalMechanicWebDashboardState();
}

class _DentalMechanicWebDashboardState
    extends State<DentalMechanicWebDashboard> {
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (!controller.isLoading &&
                                      controller.receiverContactLists.isEmpty)
                                    Center(
                                      child: Padding(
                                        padding: const EdgeInsets.symmetric(
                                          vertical: 40,
