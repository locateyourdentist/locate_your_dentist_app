...
class _WebinarListWebPageState extends State<WebinarListWebPage> {
  final GlobalKey<ScaffoldState> _scaffoldKeyWebinarList =
                            ...
                            if (!isDesktop)
                              Positioned(
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () => _scaffoldKeyWebinarList
                                      .currentState
                                      ?.openDrawer(),
                                ),
                              ),
                                    ...
                                    AnimationLimiter(
                                      child: LayoutBuilder(
                                        builder: (context, constraints) {
                                          ...
                                          int crossAxisCount = w > 1200
                                              ? 3
                                              : (w > 800 ? 2 : 1);
                                          double childAspectRatio = w < 600
                                              ? 1.3
                                              : 1.4;
                                          ...
                                          return GridView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              final appliersList = jobController
                                                  .webinarListJobSeekers[index];
                                                ...
                                                child: FadeInAnimation(
                                                  child: GestureDetector(
                                                    onTap: () async {
                                                      Api.userInfo.write(
                                                        'webinarId',
                                                        appliersList.webinarId
                                                            .toString(),
                                                      );
                                                      Api.userInfo.write(
                                                        'activeStatus1',
                                                        appliersList.isActive
                                                            .toString(),
                                                      );
      ...
      child: Center(
        child: Column(
          children: [
            ...
            Text(
              'No webinars currently available',
