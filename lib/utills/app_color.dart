import 'dart:ui';
class AppColors {
  static const Color primaryColor = Color.fromARGB(255, 247, 22, 125);
  static const Color secondaryColor = Color.fromARGB(255, 247, 22, 125);
  ...
  static const Color accentText = Color(0xFFA1A1A1);
  static const Color headingText = Color.fromARGB(255, 34, 36, 85);
  static const Color backgroundColor = Color.fromARGB(249, 249, 249, 249);
